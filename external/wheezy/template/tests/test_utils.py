...
class FindAllBalancedTestCase(unittest.TestCase):
    ...
    def test_start_out(
        ...
        assert 10 == find_all_balanced(
            "test",
            10,
        )

    def test_start_separator(
        self,
    ) -> None:
        """If text doesn't start with ``([`` return."""
        assert 0 == find_all_balanced(
            "test([",
            0,
        )
        assert 3 == find_all_balanced(
            "test([",
            3,
        )
    ...
    def test_balanced(
        ...
        assert 13 == find_all_balanced(
            "test(a, b)[0]",
            4,
        )
        assert 12 == find_all_balanced(
            "test(a, b())",
            4,
        )
        assert 17 == find_all_balanced(
            "test(a, b())[0]()",
            4,
        )
...
class FindBalancedTestCase(unittest.TestCase):
    ...
    def test_start_separator(
        ...
        assert 0 == find_balanced(
            "test(",
            0,
        )
        assert 3 == find_balanced(
            "test(",
            3,
        )
