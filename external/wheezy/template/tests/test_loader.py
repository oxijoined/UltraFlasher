...
class AutoReloadProxyTestCase(unittest.TestCase):
    ...
    def test_get_template(
        ...
        mock_stat.return_value.__getitem__.assert_called_once_with(stat.ST_MTIME)
    ...
    def test_file_not_changed_first_access(
        self,
    ) -> None:
    ...
    @patch("os.stat")
    def test_file_not_changed_known(
        self,
        mock_stat: Mock,
    ) -> None:
