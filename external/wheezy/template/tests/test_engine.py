...
class EngineTestCase(unittest.TestCase):
    ...
    def test_template_not_found(
        ...
        self.assertRaises(
            IOError,
            lambda: self.engine.get_template("x"),
        )
    ...
    def test_import_not_found(
        ...
        self.assertRaises(
            IOError,
            lambda: self.engine.import_name("x"),
        )
...
class EngineSyntaxErrorTestCase(unittest.TestCase):
    ...
    def test_compile_template_error(
        self,
    ) -> None:
        """Raises SyntaxError."""
        self.templates[
        ...
        self.assertRaises(
            SyntaxError,
            lambda: self.engine.compile_template("x"),
        )

    def test_compile_import_error(
        self,
    ) -> None:
        """Raises SyntaxError."""
        self.templates[
        ...
        self.assertRaises(
            SyntaxError,
            lambda: self.engine.compile_import("m"),
        )
