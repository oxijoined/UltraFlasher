...
from external.wheezy.template.comp import allocate_lock
...
class Preprocessor(object):
    ...
    def __init__(
        self,
        runtime_engine_factory: typing.Callable[
            [Loader],
            Engine,
        ],
        engine: Engine,
        key_factory: typing.Callable[
            [
                typing.Mapping[
                    str,
                    typing.Any,
        ...
        self.runtime_engines: typing.Dict[
            str,
            Engine,
        ] = {}
    ...
    def render(
        ...
        local_defs: typing.Mapping[
            str,
            typing.Any,
        ],
        super_defs: typing.Mapping[
            str,
            typing.Any,
        ],
    ) -> str:
        ...
        try:
            return runtime_engine.renders[name](
                ctx,
                local_defs,
                super_defs,
            )
