...
class ESP32S2ROM(ESP32ROM):
    ...
    def get_chip_features(
        ...
        block2_version = {
            ...
            self.get_block2_version(),
            "Unknown Calibration in BLK2",
        )
    ...
    def get_flash_crypt_config(
        self,
    ):
        return None  # doesn't exist on ESP32-S2

    def get_secure_boot_enabled(
        self,
    ):
        return (
    ...
    def get_key_block_purpose(
        ...
        (
            ...
            (
                self.EFUSE_PURPOSE_KEY0_REG,
                self.EFUSE_PURPOSE_KEY0_SHIFT,
            ),
            (
                self.EFUSE_PURPOSE_KEY1_REG,
                self.EFUSE_PURPOSE_KEY1_SHIFT,
            ),
            (
                self.EFUSE_PURPOSE_KEY2_REG,
                self.EFUSE_PURPOSE_KEY2_SHIFT,
            ),
            (
                self.EFUSE_PURPOSE_KEY3_REG,
                self.EFUSE_PURPOSE_KEY3_SHIFT,
            ),
            (
                self.EFUSE_PURPOSE_KEY4_REG,
                self.EFUSE_PURPOSE_KEY4_SHIFT,
            ),
            (
                self.EFUSE_PURPOSE_KEY5_REG,
                self.EFUSE_PURPOSE_KEY5_SHIFT,
            ),
        ][key_block]
        return (self.read_reg(reg) >> shift) & 0xF

    def is_flash_encryption_key_valid(
        self,
    ):
