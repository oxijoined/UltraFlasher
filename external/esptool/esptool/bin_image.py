...
class BaseFirmwareImage(object):
    ...
    def save_segment(
        ...
        """
        segment_data = self.maybe_patch_segment_data(
            f,
            segment.data,
        )
        f.write(
    ...
    def save(
        ...
        if irom_segment is not None:
            with open(
                ...
                % (
                    basename,
                    irom_segment.addr - ESP8266ROM.IROM_MAP_START,
                ),
                "wb",
            ) as f:
...
class ESP8266V2FirmwareImage(BaseFirmwareImage):
    ...
    def __init__(
        ...
        if load_file is not None:
            ...
            irom_segment = self.load_segment(
                load_file,
                True,
            )
...
class ESP32FirmwareImage(BaseFirmwareImage):
        ...
        with io.BytesIO() as f:  # write file to memory first
            ...
            while len(flash_segments) > 0:
                ...
                if pad_len > 0:  # need to pad
                    ...
                    checksum = self.save_flash_segment(
                        f,
                        segment,
                        checksum,
                    )
    ...
    def load_extended_header(
        ...
        fields = list(
            struct.unpack(
                self.EXTENDED_HEADER_STRUCT_FMT,
                load_file.read(16),
            )
        )
...
class ELFFile(object):
    ...
    def _read_sections(
        ...
        (
            ...
            sec_size,
            sec_offs,
        ) = read_section_header(shstrndx * self.LEN_SEC_HEADER)
