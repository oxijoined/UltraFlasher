...
def detect_chip(
    ...
    try:
        ...
        res = detect_port.check_command(
            "get security info",
            ESPLoader.ESP_GET_SECURITY_INFO,
            b"",
        )
...
def _update_image_flash_params(
    ...
    flash_params = struct.pack(
        b"BB",
        flash_mode,
        flash_size + flash_freq,
    )
...
def write_flash(
    ...
    if args.encrypt_files is not None:
        ...
        # let's use sorted.
        all_files = sorted(
            all_files + encrypted_files_flag,
            key=lambda x: x[0],
        )
...
def image_info(
    ...
    def v2():
        ...
        flash_s = get_key_from_value(
            image.ROM_LOADER.FLASH_SIZES,
            flash_s_bits,
        )
        print(
        ...
        flash_fr = get_key_from_value(
            image.ROM_LOADER.FLASH_FREQUENCY,
            flash_fr_bits,
        )
        print(
